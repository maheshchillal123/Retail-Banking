                                            ...
                                            <div class="all-form-element-inner">
                                                <form action="CustomerController" method="post">
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                <label class="login2 pull-right pull-right-pro">Source Account Type</label>
                                                            </div>
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                 <div class="form-select-list">
                                                                    <select class="form-control custom-select-value" name="srcacct_type">
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                <label class="login2 pull-right pull-right-pro">Target Account Type</label>
                                                            </div>
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                 <div class="form-select-list">
                                                                    <select class="form-control custom-select-value" name="targetacct_type">
																			<option>Saving</option>
																			<option>Current</option>
																		</select>
                                                                </div>
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                <label class="login2 pull-right pull-right-pro">Transfer Amount</label>
                                                            </div>
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <div class="login-horizental cancel-wp pull-left form-bc-ele">
                                                                        ...
                                                                        <button class="btn btn-sm btn-primary login-submit-cs" type="submit">Transfer</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
