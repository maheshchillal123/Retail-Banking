                        ...
                        <form action="RegisterController" id="loginForm" method="post">
                            <div class="row">
                                <div class="form-group col-lg-12">
                                    ...
                                    <input type="text" class="form-control" pattern="([a-zA-Z0-9]){8,}" name="email">
                                ...
                                <div class="form-group col-lg-6">
                                    ...
                                    <input type="password" id="pass" pattern="(^(?=.{10,}$)(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*\W).*$)" name="pass" class="form-control">
                                </div>
                                <div class="form-group col-lg-6">
                                    <label>Repeat Password</label>
                                    <input type="password" id="cpass" pattern="(^(?=.{10,}$)(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*\W).*$)" name="cpass" class="form-control">
                                </div>
